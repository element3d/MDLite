#include "SnackbarPageBase.h"

#include <e3/ViewFactory.h>
#include ".\MDLiteTestValues.h"

SnackbarPageBase::SnackbarPageBase(e3::Element* pParent)
	: e3::Element(pParent)
{
    ...
    pCustomView5->AddElement(pElement2);
        ...
        mButton = new MDButton();
        pElement2->AddElement(mButton);
        mButton->SetLabel(_s(SNACKBAR BUTTON));
        mSnackbar = new MDSnackbar();
        pElement2->AddElement(mSnackbar);
        e3::Text* pText1 = e3::ViewFactory::CreateText();
        mSnackbar->AddElement(pText1);
        pText1->SetText("Snackbar");
        pText1->SetTextColor(glm::vec4(255.000000, 255.000000, 255.000000, 255.000000));
        pText1->SetFontSize(20);
